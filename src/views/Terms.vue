<template>
  <div class="container2">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Lamden Ledger Wallet.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Lamden Ledger Wallet, accessible
          from
          <a
            href="https://lamden-ledger-wallet.web.app/"
            rel="external nofollow noopener"
            target="_blank"
            >https://lamden-ledger-wallet.web.app/</a
          >
        </p>
      </li>
      <li>
    ...
    <h1>Services Eligibility and Information</h1>

    <h2>Services Eligibility</h2>
    <p>
      The Services are offered and available to users who are 18 years of age or
      older. Any registration by, use of or access to the Services by anyone
      under 18 is unauthorized and in violation of these Terms of Service. By
      using the Services, you represent and warrant that you are 18 years of age
      or older and that you agree to abide by the Terms of Service.
    </p>

    <h2>Services Information and Limitations</h2>
    <p>
      The Site is a free, open-source, client-side interface that allows you to
      interact directly with the blockchain, while remaining in full control of
      your keys and assets.
    </p>
    <p>
      When you access certain features of the Services, you will be able to
      access a wallet to perform a variety of transactions. You also will not
      give us any of your assets, and your tokens and coins are not on Lamden
      Ledger Wallet. All assets are on the blockchain itself, and we do not
      control them. Lamden Ledger Wallet does not collect or hold your keys or
      information, and Lamden Ledger Wallet cannot access accounts; recover
      keys, passwords, or other information; reset passwords; or reverse
      transactions. You are solely responsible for your use of the Services,
      including without limitation for storing, backing-up, and maintaining the
      confidentiality of your keys, passwords, and information, and for the
      security of any transactions you perform using the Site. You expressly
      relieve and release Lamden Ledger Wallet from any and all liability and/or
      loss arising from your use of the Services.
    </p>
    <p>
      Users interacting with digital assets as investments should be aware that
      all investments involve risks, including the risk of loss of some or all
      assets. Losses are not insured, and the user assumes responsibility for
      all losses. Users are advised to exercise caution, conduct research, and
      not to transact more than they can afford to lose.
    </p>
    <p>
      Prior to using the Services for any purpose, we highly recommend that you
      read our guides, "Lamden Ledger Wallet: An Introduction," and “Pro-Tips:
      How to Avoid Phishing/Scams” on for some recommendations on how to be
      proactive about your security. In addition, we recommend that you review
      the additional FAQs, tips, and guidelines provided on the Site.
    </p>
    ...
    <p>
      ...
      SITE IS AT YOUR OWN RISK. THE SITE, ITS CONTENT AND ANY SERVICES OFFERED
      ...
      LAMDEN LEDGER WALLET NOR ANY PERSON OR ENTITY ASSOCIATED WITH LAMDEN
      LEDGER WALLET MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE
      COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY OR AVAILABILITY OF
      THE SITE OR THE SERVICES. WITHOUT LIMITING THE FOREGOING, NEITHER LAMDEN
      LEDGER WALLET NOR ANY PERSON OR ENTITY ASSOCIATED WITH LAMDEN LEDGER
      WALLET REPRESENTS OR WARRANTS THAT THE SITE, ITS CONTENT OR ANY SERVICES
      OFFERED THROUGH THE SITE WILL BE ACCURATE, RELIABLE, ERROR-FREE OR
      UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, THAT THE SITE OR THE SERVER
      THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS OR
      THAT THE SITE OR ANY SERVICES OFFERED THROUGH THE SITE WILL OTHERWISE MEET
      YOUR NEEDS OR EXPECTATIONS.
    </p>
    <p>
      LAMDEN LEDGER WALLET HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER
    ...
    <p>
      IN NO EVENT WILL LAMDEN LEDGER WALLET, ITS AFFILIATES OR THEIR LICENSORS,
      ...
      SERVICES OFFERED THROUGH THE SITE OR SUCH OTHER WEBSITES, INCLUDING ANY
    ...
    <p>
      ...
      liability or alter your rights beyond what is permitted by applicable law.
      Lamden Ledger Wallet’s liability shall be limited to the extent permitted
      by law.
    </p>
    <p>
      Access to the Site may not be legal by certain persons or in certain
      countries. You are responsible for compliance with local laws.
    </p>
